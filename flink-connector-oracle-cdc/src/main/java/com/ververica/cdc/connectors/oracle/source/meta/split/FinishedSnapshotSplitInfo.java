...
import static com.ververica.cdc.connectors.oracle.source.utils.SerializerUtils.readRedoLogPosition;
import static com.ververica.cdc.connectors.oracle.source.utils.SerializerUtils.rowToSerializedString;
import static com.ververica.cdc.connectors.oracle.source.utils.SerializerUtils.serializedStringToRow;
import static com.ververica.cdc.connectors.oracle.source.utils.SerializerUtils.writeRedoLogPosition;
...
public class FinishedSnapshotSplitInfo {
    ...
    private final RedoLogOffset highWatermark;
    ...
    public String toString() {
        return "OracleFinishedSnapshotSplitInfo{"
                + "tableId="
                + tableId
                + ", splitId='"
                + splitId
    ...
    public static byte[] serialize(FinishedSnapshotSplitInfo splitInfo) {
        try {
            ...
            writeRedoLogPosition(splitInfo.getHighWatermark(), out);
    ...
    public static FinishedSnapshotSplitInfo deserialize(byte[] serialized) {
        try {
            ...
            RedoLogOffset highWatermark = readRedoLogPosition(in);
            in.releaseArrays();
