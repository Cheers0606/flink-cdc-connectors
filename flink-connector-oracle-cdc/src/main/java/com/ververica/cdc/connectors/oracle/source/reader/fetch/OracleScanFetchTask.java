...
import static com.ververica.cdc.connectors.oracle.source.reader.fetch.OracleStreamFetchTask.OracleRedoLogSplitReadTask;
...
public class OracleScanFetchTask implements FetchTask<SourceSplitBase> {
    ...
    private OracleRedoLogSplitReadTask createBackfillRedoLogReadTask(
        ...
        return new OracleRedoLogSplitReadTask(
